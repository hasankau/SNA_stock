 ...
 * @author HASANKA
 */
public class sdn extends PopupFrame {
     ...
     * @param sdn
     */
    public sdn(Home home, PanelFrame frame, int table, SDN sdn) {
        this();
        this.home = home;
        this.frame = frame;
        this.table = table;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sdn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
