...
public class Report extends PanelFrame {
    ...
    public Report(Home home) {
        ...
        if ("admin".equals(home.getCurrentUser().getUserName())) {
            hoc = 1;
        }else{
            hoc=0;
        }
...
dateChooserCombo5.addCommitListener(new datechooser.events.CommitListener() {
    ...
    private void purchases(String d1, String d2) {
        ...
        try {
            ...
            InputStream is = new FileInputStream(new File("src/expences.jrxml"));
    ...
    private void income1(String d1, String d2) {
        try {

            InputStream is = new FileInputStream(new File("C:\\kBIT\\k5204.jrxml"));
